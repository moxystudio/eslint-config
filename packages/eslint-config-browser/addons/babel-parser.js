...
const style = require('@moxy/eslint-config-core/rules/style');
const bestPratices = require('@moxy/eslint-config-core/rules/best-practices');
const errors = require('@moxy/eslint-config-core/rules/errors');
